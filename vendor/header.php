...
<head>
    ...
    <title><?php echo APP_NAME; ?> - Vendor Dashboard</title>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="orders.php">View Orders</a></li>
                            <li><a class="dropdown-item" href="earnings.php">View Earnings</a></li>
